...
use MeeeetDev\CashierConnect\Models\ConnectSubscription;
use MeeeetDev\CashierConnect\Models\ConnectSubscriptionItem;
...
trait ManagesConnectSubscriptions
{
    ...
    private function handleConnectedCustomer($customer)
    {
        ...
        if (!in_array('MeeeetDev\CashierConnect\ConnectCustomer', $traits)) {
