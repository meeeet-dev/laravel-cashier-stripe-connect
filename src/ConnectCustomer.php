...
use MeeeetDev\CashierConnect\Concerns\ManageCustomer;
use MeeeetDev\CashierConnect\Exceptions\AccountNotFoundException;
use MeeeetDev\CashierConnect\Concerns\ManageConnectedPaymentMethods;
...
trait ConnectCustomer
{
    ...
    public function stripeAccountOptions($connectedAccount, array $options = []): array
    {
        ...
        if (gettype($connectedAccount) === 'string') {
            ...
            if (!in_array('MeeeetDev\CashierConnect\Billable', $traits)) {
